...
insert into students1 values(005,'Loki'),(1001,'Srihari'),(1003,'Dinesh'),(001,'Karthick'),(1005,'Tharun'),
...
select * from award_winners
where id=(select id from students1 where id=1);

select * from award_winners
where id=(select id from students1 where name="Loki");